  ...
  <div class="authentication-inner row">
    ...
    <div class="d-none d-lg-flex col-lg-7 p-0">
      <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
        ...
        <img src="{{ asset('gallery/377942488_278540508451973_3190037392243969563_n.jpg') }}" alt="auth-login-cover" class="img-fluid my-5 auth-illustration">
      ...
      <div class="w-px-400 mx-auto">
        ...
        <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('auth') is-invalid @enderror" id="auth" name="auth" placeholder="john@example.com/6282273318016" required value="{{ old('auth') }}">
            @error('auth')
